...
// use claudelang_stdlib::registry::STDLIB_REGISTRY;
use claudelang_effects::EffectContext;
// TODO: Use contract verifier when available
// use claudelang_contracts::{ContractVerifier, ContractViolation};
use claudelang_types::TypeChecker;
...
/// Tree-walking interpreter for ClaudeLang
