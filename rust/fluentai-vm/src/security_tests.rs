...
mod tests {
    use super::super::*;
    use crate::security::{
        Capability, SecurityContext, SecurityManager, SecurityPolicy, TaintLevel, TaintTracker,
    };
    ...
    fn test_security_context_capabilities() {
        ...
        // Add a capability
        let file_cap = Capability::FileSystem {
    ...
    fn test_resource_limits() {
        ...
        for i in 0..10 {
            assert!(
                context2.track_instruction().is_ok(),
    ...
    fn test_module_isolation() {
        ...
        // Check isolation
        assert_eq!(
            isolation.get_module_global("module1", "x"),
            Some(Value::Integer(42))
        );
        assert_eq!(
            isolation.get_module_global("module2", "x"),
    ...
    fn test_module_import_restrictions() {
        ...
        context.grant_capability(Capability::ModuleImport {
            modules: vec!["math".to_string()],
        });
        context.grant_capability(Capability::ModuleImport {
            modules: vec!["string".to_string()],
        });
        ...
        let wildcard = Capability::ModuleImport {
    ...
    fn test_capability_subsets() {
        ...
        let fs_tmp = Capability::FileSystem {
            paths: vec!["/tmp".to_string()],
        };
        let fs_home = Capability::FileSystem {
