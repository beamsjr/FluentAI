...
mod tests {
    ...
    mod debug_events {
        ...
        fn test_stack_push_event() {
            ...
            match event {
                VMDebugEvent::StackPush { value } => match value {
                    Value::List(items) => {
        ...
        fn test_breakpoint_event() {
            let event = VMDebugEvent::Breakpoint { pc: 50 };
    ...
    async fn test_event_channel_integration() {
        ...
        for expected in events {
            ...
            match (expected, received) {
                ...
                (VMDebugEvent::StackPush { value: v1 }, VMDebugEvent::StackPush { value: v2 }) => {
                    assert_eq!(v1, v2);
                }
                (
                    VMDebugEvent::PostInstruction {
