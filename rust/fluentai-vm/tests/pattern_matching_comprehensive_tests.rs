...
fn test_match_integer_literal() -> Result<()> {
    ...
    let result1 = graph
        ...
        .expect("Failed to add node");
    let result2 = graph
        .add_node(Node::Literal(Literal::String("not 42".to_string())))
        .expect("Failed to add node");
...
fn test_match_string_literal() -> Result<()> {
    ...
    let value = graph
        ...
        .expect("Failed to add node");
    let result1 = graph
        .add_node(Node::Literal(Literal::String("greeting".to_string())))
        .expect("Failed to add node");
    let result2 = graph
        .add_node(Node::Literal(Literal::String("not greeting".to_string())))
        .expect("Failed to add node");
...
fn test_match_boolean_literals() -> Result<()> {
    ...
    let true_result = graph
        ...
        .expect("Failed to add node");
    let false_result = graph
        .add_node(Node::Literal(Literal::String("is false".to_string())))
        .expect("Failed to add node");

    let match_true = graph
        .add_node(Node::Match {
            expr: true_val,
            branches: vec![
...
fn test_match_variable_binding() -> Result<()> {
    ...
    let match_node = graph
        .add_node(Node::Match {
            expr: value,
            branches: vec![(Pattern::Variable("x".to_string()), x_var)],
        })
        .expect("Failed to add node");
    graph.root_id = Some(match_node);
...
fn test_wildcard_pattern() -> Result<()> {
    ...
    let value = graph
        .add_node(Node::Literal(Literal::Integer(999)))
        .expect("Failed to add node");
    let default_result = graph
        .add_node(Node::Literal(Literal::String("default".to_string())))
        .expect("Failed to add node");

    let match_node = graph
        .add_node(Node::Match {
            expr: value,
            branches: vec![(Pattern::Wildcard, default_result)],
        })
        .expect("Failed to add node");
    graph.root_id = Some(match_node);
...
fn test_wildcard_with_other_patterns() -> Result<()> {
    ...
    let value = graph
        .add_node(Node::Literal(Literal::Integer(999)))
        .expect("Failed to add node");
    let specific_result = graph
        .add_node(Node::Literal(Literal::String("found 42".to_string())))
        .expect("Failed to add node");
    let default_result = graph
        .add_node(Node::Literal(Literal::String("not 42".to_string())))
        .expect("Failed to add node");
...
fn test_multiple_pattern_branches() -> Result<()> {
    ...
    let result1 = graph
        ...
        .expect("Failed to add node");
    let result2 = graph
        .add_node(Node::Literal(Literal::String("two".to_string())))
        .expect("Failed to add node");
    let result3 = graph
        .add_node(Node::Literal(Literal::String("three".to_string())))
        .expect("Failed to add node");
    let default = graph
...
fn test_pattern_matching_with_aggressive_optimization() -> Result<()> {
    ...
    let empty_result = graph
        ...
        .expect("Failed to add node");
    let non_empty = graph
        .add_node(Node::Literal(Literal::String("has items".to_string())))
        .expect("Failed to add node");
...
fn test_match_list_with_wrong_pattern_order() -> Result<()> {
    ...
    let nil_result = graph
        .add_node(Node::Literal(Literal::String("nil".to_string())))
        .expect("Failed to add node");
    let cons_result = graph
        .add_node(Node::Literal(Literal::String("cons".to_string())))
        .expect("Failed to add node");
