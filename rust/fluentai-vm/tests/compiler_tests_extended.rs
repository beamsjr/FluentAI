...
fn test_compile_string_operations() -> Result<()> {
    ...
    let str_len = graph.add_node(Node::Variable { name: "str-len".to_string() }).expect("Failed to add node");
...
fn test_compile_list_operations() -> Result<()> {
    ...
    let two = graph.add_node(Node::Literal(Literal::Integer(2))).expect("Failed to add node");
    let three = graph.add_node(Node::Literal(Literal::Integer(3))).expect("Failed to add node");
    let list_node = graph.add_node(Node::List(vec![two, three])).expect("Failed to add node");
...
fn test_compile_multiple_bindings_access() -> Result<()> {
    ...
    let z_val = graph.add_node(Node::Literal(Literal::Integer(30))).expect("Failed to add node");
...
fn test_compile_if_false_branch() -> Result<()> {
    ...
    let then_val = graph.add_node(Node::Literal(Literal::String("then".to_string()))).expect("Failed to add node");
    let else_val = graph.add_node(Node::Literal(Literal::String("else".to_string()))).expect("Failed to add node");
...
fn test_compile_nested_if() -> Result<()> {
    ...
    let inner_cond = graph.add_node(Node::Literal(Literal::Boolean(false))).expect("Failed to add node");
    let one = graph.add_node(Node::Literal(Literal::Integer(1))).expect("Failed to add node");
    let two = graph.add_node(Node::Literal(Literal::Integer(2))).expect("Failed to add node");
    ...
    let outer_cond = graph.add_node(Node::Literal(Literal::Boolean(true))).expect("Failed to add node");
    let three = graph.add_node(Node::Literal(Literal::Integer(3))).expect("Failed to add node");
...
fn test_compile_letrec_simple() -> Result<()> {
    ...
    let n_var1 = graph.add_node(Node::Variable { name: "n".to_string() }).expect("Failed to add node");
    let n_var2 = graph.add_node(Node::Variable { name: "n".to_string() }).expect("Failed to add node");
    let n_var3 = graph.add_node(Node::Variable { name: "n".to_string() }).expect("Failed to add node");
    let _n_var4 = graph.add_node(Node::Variable { name: "n".to_string() }).expect("Failed to add node");
    ...
    let fact_var = graph.add_node(Node::Variable { name: "fact".to_string() }).expect("Failed to add node");
    ...
    let fact_var2 = graph.add_node(Node::Variable { name: "fact".to_string() }).expect("Failed to add node");
...
fn test_compile_letrec_mutual_recursion() -> Result<()> {
    ...
    // even? function
    let n_var_even1 = graph.add_node(Node::Variable { name: "n".to_string() }).expect("Failed to add node");
    let n_var_even2 = graph.add_node(Node::Variable { name: "n".to_string() }).expect("Failed to add node");
    let zero1 = graph.add_node(Node::Literal(Literal::Integer(0))).expect("Failed to add node");
    let eq1 = graph.add_node(Node::Variable { name: "=".to_string() }).expect("Failed to add node");
    ...
    let minus1 = graph.add_node(Node::Variable { name: "-".to_string() }).expect("Failed to add node");
    let one1 = graph.add_node(Node::Literal(Literal::Integer(1))).expect("Failed to add node");
    let sub_even = graph.add_node(Node::Application {
        function: minus1,
        args: vec![n_var_even2, one1],
    }).expect("Failed to add node");
    
    let odd_var = graph.add_node(Node::Variable { name: "odd?".to_string() }).expect("Failed to add node");
    ...
    // odd? function
    let n_var_odd1 = graph.add_node(Node::Variable { name: "n".to_string() }).expect("Failed to add node");
    let n_var_odd2 = graph.add_node(Node::Variable { name: "n".to_string() }).expect("Failed to add node");
    let zero2 = graph.add_node(Node::Literal(Literal::Integer(0))).expect("Failed to add node");
    let eq2 = graph.add_node(Node::Variable { name: "=".to_string() }).expect("Failed to add node");
    ...
    let minus2 = graph.add_node(Node::Variable { name: "-".to_string() }).expect("Failed to add node");
    let one2 = graph.add_node(Node::Literal(Literal::Integer(1))).expect("Failed to add node");
    let sub_odd = graph.add_node(Node::Application {
        function: minus2,
        args: vec![n_var_odd2, one2],
    }).expect("Failed to add node");
    
    let even_var = graph.add_node(Node::Variable { name: "even?".to_string() }).expect("Failed to add node");
    ...
    // Call even? with 4
    let even_var2 = graph.add_node(Node::Variable { name: "even?".to_string() }).expect("Failed to add node");
...
fn test_compile_letrec_with_closure() -> Result<()> {
    ...
    let counter_var = graph.add_node(Node::Variable { name: "counter".to_string() }).expect("Failed to add node");
...
fn test_compile_letrec_empty_bindings() -> Result<()> {
    ...
    // Create (letrec () 42)
    let forty_two = graph.add_node(Node::Literal(Literal::Integer(42))).expect("Failed to add node");
    let letrec_node = graph.add_node(Node::Letrec {
        bindings: vec![],
        body: forty_two,
    }).expect("Failed to add node");
...
fn test_compile_logical_operators() -> Result<()> {
    ...
    let t = graph.add_node(Node::Literal(Literal::Boolean(true))).expect("Failed to add node");
    let f = graph.add_node(Node::Literal(Literal::Boolean(false))).expect("Failed to add node");
...
fn test_compile_large_list() -> Result<()> {
    ...
    let list_node = graph.add_node(Node::List(elements)).expect("Failed to add node");
...
fn test_compile_pattern_matching_nil() -> Result<()> {
    ...
    let empty_str = graph.add_node(Node::Literal(Literal::String("empty".to_string()))).expect("Failed to add node");
    let not_empty_str = graph.add_node(Node::Literal(Literal::String("not empty".to_string()))).expect("Failed to add node");
...
fn test_compile_pattern_matching_tail() -> Result<()> {
    ...
    let two = graph.add_node(Node::Literal(Literal::Integer(2))).expect("Failed to add node");
    let three = graph.add_node(Node::Literal(Literal::Integer(3))).expect("Failed to add node");
    let list_val = graph.add_node(Node::List(vec![one, two, three])).expect("Failed to add node");
...
fn test_compile_pattern_matching_nested() -> Result<()> {
    ...
    let one = graph.add_node(Node::Literal(Literal::Integer(1))).expect("Failed to add node");
    let two = graph.add_node(Node::Literal(Literal::Integer(2))).expect("Failed to add node");
    let inner_list = graph.add_node(Node::List(vec![one, two])).expect("Failed to add node");
    let three = graph.add_node(Node::Literal(Literal::Integer(3))).expect("Failed to add node");
    let outer_list = graph.add_node(Node::List(vec![inner_list, three])).expect("Failed to add node");
...
fn test_compile_pattern_matching_with_optimization() -> Result<()> {
    ...
    */
    ...
    let two_lit = graph.add_node(Node::Literal(Literal::Integer(2))).expect("Failed to add node");
    let three_lit = graph.add_node(Node::Literal(Literal::Integer(3))).expect("Failed to add node");
    let expected_tail = graph.add_node(Node::List(vec![two_lit, three_lit])).expect("Failed to add node");
    let empty_list = graph.add_node(Node::List(vec![])).expect("Failed to add node");
