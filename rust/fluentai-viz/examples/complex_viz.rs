//! Complex visualization example with many nodes

use anyhow::Result;
use fluentai_parser::parse;
use fluentai_vm::{Compiler, VM, DebugConfig, VMDebugEvent};
use fluentai_viz::{
...
async fn main() -> Result<()> {
    ...
    println!("===========================================");
    println!("FluentAi Complex Visualization Example");
    println!("===========================================");
    ...
    // Complex nested arithmetic expression
    // This calculates: ((2 + 3) * (4 + 5)) - ((6 * 7) + (8 - 9))
    // = (5 * 9) - (42 + (-1))
    // = 45 - 41
    // = 4
    let source = r#"
    ...
    println!("{}", source);
    println!();
    println!("This expression has many nodes showing:");
    println!("- Nested arithmetic operations");
    println!("- Multiple levels of computation");
    println!("- Tree structure with depth");
    ...
    println!("Watch the stack grow and shrink as operations execute!");
    ...
    println!("You can explore the graph and debug events.");
