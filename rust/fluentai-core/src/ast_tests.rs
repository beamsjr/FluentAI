...
mod tests {
    ...
    fn test_nodes_iterator() {
        ...
        let str_id = graph.add_node(Node::Literal(Literal::String("hello".to_string()))).unwrap();
        let var_id = graph.add_node(Node::Variable { name: "x".to_string() }).unwrap();
    ...
    fn test_children() {
        ...
        let cond = graph.add_node(Node::Literal(Literal::Boolean(true))).unwrap();
    ...
    fn test_dfs_traversal_all_node_types() {
        ...
        // Test Let traversal
        let value = graph.add_node(Node::Literal(Literal::String("hello".to_string()))).unwrap();
        let let_body = graph.add_node(Node::Variable { name: "x".to_string() }).unwrap();
        ...
        let rec_body = graph.add_node(Node::Variable { name: "f".to_string() }).unwrap();
        ...
        let branch1 = graph.add_node(Node::Literal(Literal::String("five".to_string()))).unwrap();
        let branch2 = graph.add_node(Node::Literal(Literal::String("other".to_string()))).unwrap();
        ...
        let arg1 = graph.add_node(Node::Literal(Literal::String("hello".to_string()))).unwrap();
        let arg2 = graph.add_node(Node::Literal(Literal::String("world".to_string()))).unwrap();
    ...
    fn test_dfs_with_cycles() {
        ...
        let c = graph.add_node(Node::Variable { name: "c".to_string() }).unwrap();
    ...
    fn test_lambda_node() {
        let mut graph = Graph::new();
        let body = graph.add_node(Node::Variable { name: "x".to_string() }).unwrap();
        let lambda = graph.add_node(Node::Lambda {
            params: vec!["x".to_string()],
            body,
        }).unwrap();
    ...
    fn test_match_node() {
        ...
        let branch1 = graph.add_node(Node::Literal(Literal::String("forty-two".to_string()))).unwrap();
        let branch2 = graph.add_node(Node::Literal(Literal::String("other".to_string()))).unwrap();
    ...
    fn test_effect_node() {
        let mut graph = Graph::new();
        let arg = graph.add_node(Node::Literal(Literal::String("Hello, World!".to_string()))).unwrap();
    ...
    fn test_async_constructs() {
        ...
        // Test Send node
        let value = graph.add_node(Node::Literal(Literal::String("message".to_string()))).unwrap();
    ...
    fn test_spawn_node() {
        ...
        let computation = graph.add_node(Node::Literal(Literal::String("compute".to_string()))).unwrap();
    ...
    fn test_letrec_node() {
        ...
        let _n_var = graph.add_node(Node::Variable { name: "n".to_string() }).unwrap();
    ...
    fn test_contract_node() {
        ...
        let precond = graph.add_node(Node::Literal(Literal::Boolean(true))).unwrap();
        let postcond = graph.add_node(Node::Literal(Literal::Boolean(true))).unwrap();
        let invariant = graph.add_node(Node::Literal(Literal::Boolean(true))).unwrap();
    ...
    fn test_validate_dangling_reference() {
        let mut graph = Graph::new();
        let func = graph.add_node(Node::Variable { name: "f".to_string() }).unwrap();
    ...
    fn test_validate_metadata_for_nonexistent_node() {
        ...
        let result = graph.validate();
        assert!(result.is_err());
        assert!(result.unwrap_err().to_string().contains("Metadata exists for non-existent"));
    }
    ...
    fn test_validate_cycle_detection() {
        ...
        graph.nodes.insert(node_a, Node::List(vec![node_b_placeholder]));
        
        // Update node_b to reference node_a (creating cycle)
        graph.nodes.insert(node_b_placeholder, Node::List(vec![node_a]));
    ...
    fn test_structured_performance_hints() {
        ...
        match &retrieved.performance_hints[2].hint_type {
            PerformanceHintType::MemoryAccessPattern(pattern) => {
                match pattern {
    ...
    fn test_all_performance_hint_types() {
        let hints = vec![
            ...
            PerformanceHintType::CanParallelize { strategy: ParallelismStrategy::DataParallel },
            PerformanceHintType::ShouldMemoize { max_cache_size: None },
    ...
    fn test_nodes_iterator_with_types() {
        ...
        // Add some nodes
        let id1 = graph.add_node(Node::Literal(Literal::Integer(1))).unwrap();
        let id2 = graph.add_node(Node::Variable { name: "x".to_string() }).unwrap();
        let id3 = graph.add_node(Node::Literal(Literal::String("hello".to_string()))).unwrap();
    ...
    fn test_dfs_if_traversal() {
        ...
        let then_branch = graph.add_node(Node::Literal(Literal::String("positive".to_string()))).unwrap();
        let else_branch = graph.add_node(Node::Literal(Literal::String("non-positive".to_string()))).unwrap();
    ...
    fn test_dfs_match_traversal() {
        ...
        let x = graph.add_node(Node::Variable { name: "x".to_string() }).unwrap();
        let zero_branch = graph.add_node(Node::Literal(Literal::String("zero".to_string()))).unwrap();
        let one_branch = graph.add_node(Node::Literal(Literal::String("one".to_string()))).unwrap();
        let other_branch = graph.add_node(Node::Literal(Literal::String("other".to_string()))).unwrap();
    ...
    fn test_dfs_list_traversal() {
        ...
        let outer_list = graph.add_node(Node::List(vec![one, two, inner_list])).unwrap();
    ...
    fn test_dfs_effect_traversal() {
        ...
        let hello = graph.add_node(Node::Literal(Literal::String("Hello".to_string()))).unwrap();
        let world = graph.add_node(Node::Literal(Literal::String("World".to_string()))).unwrap();
