...
mod tests {
    ...
    fn test_invalid_arity_error() {
        let err = Error::InvalidArity { expected: 2, got: 3 };
    ...
    fn test_contract_violation_error() {
        ...
        assert_eq!(err.to_string(), "Contract violation: precondition failed: x > 0");
    }
    ...
    fn test_error_matching() {
        let errors = vec![
            ...
            Error::InvalidArity { expected: 1, got: 2 },
    ...
    fn test_error_display_formatting() {
        ...
        assert_eq!(Error::Runtime("".to_string()).to_string(), "Runtime error: ");
    ...
    fn test_invalid_arity_formatting() {
        ...
        assert_eq!(
            Error::InvalidArity { expected: 0, got: 1 }.to_string(),
            "Invalid arity: expected 0, got 1"
        );
        
        assert_eq!(
            Error::InvalidArity { expected: 10, got: 5 }.to_string(),
            "Invalid arity: expected 10, got 5"
        );
        
        assert_eq!(
            Error::InvalidArity { expected: 1, got: 1 }.to_string(),
