#[cfg(test)]
mod tests {
    use crate::query::{GraphQuery, QueryResult, QueryExecutor, Constraint, SelectClause, OrderBy};
    use crate::patterns::{Pattern, NodePattern, MatchResult};
    ...
    fn test_query_result_with_matches() {
        ...
        match1.matched_nodes.push(NodeId(NonZeroU32::new(1).unwrap()));
        
        let mut match2 = MatchResult::new();
        match2.matched_nodes.push(NodeId(NonZeroU32::new(2).unwrap()));
