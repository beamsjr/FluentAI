...
pub enum NodePattern {
    ...
    Application {
        function: Box<Pattern>,
        args: Vec<Pattern>,
    },
    Let {
        bindings: Vec<(String, Pattern)>,
        body: Box<Pattern>,
    },
    If {
        condition: Box<Pattern>,
        then_branch: Box<Pattern>,
        else_branch: Box<Pattern>,
    },
    List(Vec<Pattern>),
    Effect {
...
impl<'a> PatternMatcher<'a> {
    ...
    pub fn match_pattern(&mut self, pattern: &Pattern, node_id: NodeId) -> Option<MatchResult> {
        ...
        match pattern {
            ...
            Pattern::NodeType(node_pattern) => self.match_node_pattern(node_pattern, node, node_id),
    ...
    fn match_node_pattern(
        ...
        match (pattern, node) {
            ...
            (
                NodePattern::Lambda { params, body },
                Node::Lambda {
                    params: node_params,
                    body: node_body,
                },
            ...
            (
                NodePattern::Application { function, args },
                Node::Application {
                    function: node_func,
                    args: node_args,
                },
