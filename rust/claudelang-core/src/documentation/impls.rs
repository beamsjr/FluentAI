...
use crate::documentation::traits::{DocumentedNode, DocumentationCategory};
...
impl DocumentedNode for IntegerDoc {
    ...
    fn syntax() -> &'static str { "<integer>" }
    
    fn description() -> &'static str {
        "Integer literals represent whole numbers. ClaudeLang supports 64-bit signed integers."
    }
...
impl DocumentedNode for FloatDoc {
    ...
    fn syntax() -> &'static str { "<float>" }
    
    fn description() -> &'static str {
        "Floating-point literals represent decimal numbers. ClaudeLang uses 64-bit double precision."
    }
...
impl DocumentedNode for BooleanDoc {
    fn name() -> &'static str { "Boolean" }
    
    fn syntax() -> &'static str { "true | false" }
...
impl DocumentedNode for NilDoc {
    fn name() -> &'static str { "Nil" }
    
    fn syntax() -> &'static str { "nil" }
...
impl DocumentedNode for VariableDoc {
    fn name() -> &'static str { "Variable" }
    
    fn syntax() -> &'static str { "<identifier>" }
...
impl DocumentedNode for LambdaDoc {
    fn name() -> &'static str { "Lambda" }
    
    fn syntax() -> &'static str { "(lambda (<params>) <body>)" }
...
impl DocumentedNode for LetDoc {
    fn name() -> &'static str { "Let" }
    
    fn syntax() -> &'static str { "(let ((<var> <expr>) ...) <body>)" }
...
impl DocumentedNode for LetrecDoc {
    fn name() -> &'static str { "Letrec" }
    
    fn syntax() -> &'static str { "(letrec ((<var> <expr>) ...) <body>)" }
...
impl DocumentedNode for IfDoc {
    fn name() -> &'static str { "If" }
    
    fn syntax() -> &'static str { "(if <condition> <then> <else>)" }
...
impl DocumentedNode for ApplicationDoc {
    fn name() -> &'static str { "Application" }
    
    fn syntax() -> &'static str { "(<function> <arg1> <arg2> ...)" }
...
impl DocumentedNode for MatchDoc {
    fn name() -> &'static str { "Match" }
    
    fn syntax() -> &'static str { "(match <expr> (<pattern> <body>) ...)" }
...
impl DocumentedNode for AsyncDoc {
    fn name() -> &'static str { "Async" }
    
    fn syntax() -> &'static str { "(async <body>)" }
...
impl DocumentedNode for AwaitDoc {
    ...
    fn syntax() -> &'static str { "(await <async-expr>)" }
...
impl DocumentedNode for SpawnDoc {
    fn name() -> &'static str { "Spawn" }
    
    fn syntax() -> &'static str { "(spawn <expr>)" }
...
impl DocumentedNode for ChannelDoc {
    fn name() -> &'static str { "Channel" }
    
    fn syntax() -> &'static str { "(chan)" }
...
impl DocumentedNode for SendDoc {
    fn name() -> &'static str { "Send" }
    
    fn syntax() -> &'static str { "(send! <channel> <value>)" }
...
impl DocumentedNode for ReceiveDoc {
    fn name() -> &'static str { "Receive" }
    
    fn syntax() -> &'static str { "(recv! <channel>)" }
