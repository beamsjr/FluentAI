//! Demonstration of ClaudeLang optimization capabilities
...
fn main() {
    println!("ClaudeLang Optimization Demo\n");
    ...
    for level in &levels {
        ...
        if *level == OptimizationLevel::Aggressive {
            println!("\nAchieved {}% performance improvement with aggressive optimization!", reduction);
            if reduction >= 20.0 {
