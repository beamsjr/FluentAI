...
mod tests {
    ...
    use crate::types::{FunctionType, ListType, PrimitiveType, RecordType, TypedValue};
    ...
    fn test_define_type() {
        ...
        let list_int = TypedValue::list(ListType::new(TypedValue::primitive(PrimitiveType::int())));
    ...
    fn test_environment_builder_with_type_def() {
        let list_type =
            TypedValue::list(ListType::new(TypedValue::primitive(PrimitiveType::float())));
    ...
    fn test_type_definition_lookup() {
        ...
        let my_list = TypedValue::list(ListType::new(TypedValue::primitive(PrimitiveType::int())));
