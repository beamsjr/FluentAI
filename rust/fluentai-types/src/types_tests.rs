...
mod tests {
    ...
    fn test_function_no_params() {
        let func = FunctionType::new(vec![], TypedValue::primitive(PrimitiveType::int()));
    ...
    fn test_single_element_tuple() {
        let tuple = TupleType::new(vec![TypedValue::primitive(PrimitiveType::bool())]);
    ...
    fn test_record_field_access() {
        let record =
            RecordType::new().with_field("x", TypedValue::primitive(PrimitiveType::float()));
    ...
    fn test_type_constraint_display() {
        ...
        assert_eq!(
            TypeConstraint::HasTrait("Show".to_string()).to_string(),
            "Show"
        );
        assert_eq!(
            TypeConstraint::SubtypeOf("Animal".to_string()).to_string(),
            "<: Animal"
        );
    }
    ...
    fn test_effect_propagation_in_function() {
        ...
        let func = FunctionType::new(vec![param], TypedValue::primitive(PrimitiveType::unit()));
