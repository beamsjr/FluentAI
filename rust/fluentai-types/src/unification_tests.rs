...
mod advanced_unification_tests {
    ...
    fn test_complex_substitution() {
        ...
        let inner_func = TypedValue::function(FunctionType::new(vec![t2.clone()], t3.clone()));
        let outer_func = TypedValue::function(FunctionType::new(vec![t1.clone()], inner_func));
    ...
    fn test_substitution_composition() {
        ...
        subst2.insert(
            "T2".to_string(),
            TypedValue::variable(TypeVariable::new("T1")),
        );
    ...
    fn test_nested_polymorphic_unification() {
        ...
        let map_type = TypedValue::function(FunctionType::new(vec![mapper, list_a], list_b));
        ...
        let string_list = TypedValue::list(ListType::new(TypedValue::primitive(
    ...
    fn test_tuple_unification() {
        ...
        let tuple4 = TypedValue::tuple(TupleType::new(vec![TypedValue::primitive(
            PrimitiveType::int(),
        )]));
    ...
    fn test_variant_tag_mismatch() {
        ...
        let variant2 = TypedValue::variant(
            VariantType::new()
                ...
                .with_variant(
                    "Failure",
                    Some(TypedValue::primitive(PrimitiveType::string())),
                ),
        );
    ...
    fn test_complex_occurs_check_in_variant() {
        ...
        let t = TypedValue::variable(TypeVariable::new("T"));
        let variant =
            TypedValue::variant(VariantType::new().with_variant("Recursive", Some(t.clone())));
    ...
    fn test_error_display() {
        ...
        assert!(err2
            .to_string()
            .contains("Occurs check failed: T occurs in [T]"));
        ...
        assert!(err4
            .to_string()
            .contains("Arity mismatch: expected 2 arguments, found 3"));
    ...
    fn test_unify_with_type_constraints() {
        ...
        let t1 =
            TypedValue::variable(TypeVariable::new("T").with_constraint(TypeConstraint::Numeric));
