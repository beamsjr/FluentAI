//! Complete demonstration of ClaudeLang database features
//! 
//! This example shows:
//! - Query builder usage
//! - Schema creation
...
fn main() {
    println!("=== ClaudeLang Database System Demo ===\n");
...
fn query_builder_demo() {
    ...
    let age_param = builder.next_param(claudelang_vm::bytecode::Value::Int(18));
    let status_param = builder.next_param(claudelang_vm::bytecode::Value::String("active".to_string()));
