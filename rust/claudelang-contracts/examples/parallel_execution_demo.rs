...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Example 1: Complex branching function
    {
        ...
        let function_id = claudelang_core::ast::NodeId(1); // Would need proper lookup
    ...
    println!("\n\n=== Batch Function Execution ===\n");
    {
        ...
        let functions = vec![
            (claudelang_core::ast::NodeId(1), vec!["x".to_string()]),
            (claudelang_core::ast::NodeId(2), vec!["x".to_string(), "y".to_string()]),
            (claudelang_core::ast::NodeId(3), vec!["a".to_string(), "b".to_string(), "c".to_string()]),
        ];
