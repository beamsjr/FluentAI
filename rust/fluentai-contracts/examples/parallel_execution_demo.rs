...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    // Example 1: Complex branching function
    {
        ...
        let sequential_states =
            sequential_executor.execute_function_by_name(&graph, "complex-branch")?;
        ...
        println!(
            "  States/second: {:.2}",
            sequential_states.len() as f64 / sequential_time.as_secs_f64()
        );
        ...
        println!(
            "  States/second: {:.2}",
            parallel_states.len() as f64 / parallel_time.as_secs_f64()
        );
        println!(
            "  Speedup: {:.2}x",
    ...
    println!("\n\n=== Recursive Function Parallel Exploration ===\n");
    {
        ...
        println!(
            ...
            config.work_stealing_threshold
        );
        ...
        println!(
            "  Paths/second: {:.2}",
            states.len() as f64 / duration.as_secs_f64()
        );
    }
    ...
    println!("\n\n=== Batch Function Execution ===\n");
    {
        ...
        let functions = vec![
            ...
            (
                fluentai_core::ast::NodeId(NonZero::new(2).unwrap()),
                vec!["x".to_string(), "y".to_string()],
            ),
            (
                fluentai_core::ast::NodeId(NonZero::new(3).unwrap()),
