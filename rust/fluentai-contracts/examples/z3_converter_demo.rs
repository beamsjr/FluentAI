...
fn main() {
    ...
    println!("Example 1: Verify (x mod 2 = 0) => even?(x)");
    {
        ...
        // x mod 2
        let mod_op = graph.add_node(Node::Variable { name: "mod".to_string() }).expect("Failed to add node");
        ...
        // x mod 2 = 0
        let eq_op = graph.add_node(Node::Variable { name: "=".to_string() }).expect("Failed to add node");
        ...
        // even?(x)
        let even_pred = graph.add_node(Node::Variable { name: "even?".to_string() }).expect("Failed to add node");
        ...
        // (x mod 2 = 0) => even?(x)
        let implies_op = graph.add_node(Node::Variable { name: "implies".to_string() }).expect("Failed to add node");
    ...
    println!("\nExample 2: Min/Max properties");
    {
        ...
        // min(x, y)
        let min_op = graph.add_node(Node::Variable { name: "min".to_string() }).expect("Failed to add node");
        ...
        // min(x, y) <= x
        let le_op = graph.add_node(Node::Variable { name: "<=".to_string() }).expect("Failed to add node");
    ...
    println!("\nExample 3: Absolute value properties");
    {
        ...
        // abs(x)
        let abs_op = graph.add_node(Node::Variable { name: "abs".to_string() }).expect("Failed to add node");
    ...
    println!("\nExample 4: Complex logical formula");
    {
        ...
        // positive?(x)
        let pos_pred = graph.add_node(Node::Variable { name: "positive?".to_string() }).expect("Failed to add node");
        ...
        // negative?(y)
        let neg_pred = graph.add_node(Node::Variable { name: "negative?".to_string() }).expect("Failed to add node");
        ...
        // x + y
        let plus_op = graph.add_node(Node::Variable { name: "+".to_string() }).expect("Failed to add node");
