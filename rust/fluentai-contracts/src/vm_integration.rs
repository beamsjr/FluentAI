...
impl ContractRegistry {
        ...
        for (node_id, node) in &graph.nodes {
            ...
            } = node
            {
                ...
                for &pre_id in preconditions {
                    contract.add_precondition(crate::contract::ContractCondition::new(
                        pre_id,
                ...
                for &post_id in postconditions {
                    contract.add_postcondition(crate::contract::ContractCondition::new(
                        post_id,
                ...
                for &inv_id in invariants {
                    contract.add_invariant(crate::contract::ContractCondition::new(
                        inv_id,
    ...
    pub fn check_postconditions(
        ...
        let mut ctx =
            VerificationContext::post(function_name.to_string(), args.to_vec(), result.clone());
...
mod tests {
    ...
    fn test_contract_registry() {
        ...
        registry
            .register_function_params("add".to_string(), vec!["a".to_string(), "b".to_string()]);
