//! Language Server Protocol implementation for ClaudeLang
//! 
...
impl LanguageServer for ClaudeLangServer {
    async fn initialize(&self, _: InitializeParams) -> JsonRpcResult<InitializeResult> {
        info!("Initializing ClaudeLang Language Server");
    ...
    async fn initialized(&self, _: InitializedParams) {
        info!("ClaudeLang Language Server initialized");
    }

    async fn shutdown(&self) -> JsonRpcResult<()> {
        info!("Shutting down ClaudeLang Language Server");
        Ok(())
    }
...
pub async fn run_server() -> Result<()> {
    ...
    let (service, socket) = LspService::new(ClaudeLangServer::new);
