...
mod lexer_edge_tests {
    ...
    fn test_slice_method() {
        ...
        // Get first token
        assert_eq!(lexer.next_token(), Some(Token::Symbol("hello")));
        ...
        // Get third token
        assert_eq!(lexer.next_token(), Some(Token::Symbol("world")));
    ...
    fn test_peek_then_next() {
        ...
        assert_eq!(lexer.peek_token(), Some(&Token::Symbol("bar")));
        
        // Next should return the peeked token again
        assert_eq!(lexer.next_token(), Some(Token::Symbol("bar")));
        
        // One more time
        assert_eq!(lexer.peek_token(), Some(&Token::Symbol("baz")));
    ...
    fn test_span_after_peek() {
        ...
        // Peek first token
        assert_eq!(lexer.peek_token(), Some(&Token::Symbol("hello")));
        ...
        // Peek next token
        assert_eq!(lexer.peek_token(), Some(&Token::Symbol("world")));
    ...
    fn test_multiple_peek_span_interactions() {
        ...
        assert_eq!(lexer.peek_token(), Some(&Token::Symbol("+")));
    ...
    fn test_string_with_trailing_backslash_in_content() {
        ...
        assert_eq!(lexer.next_token(), Some(Token::String("content\\".to_string())));
    }
    ...
    fn test_process_string_escapes_direct() {
        ...
        use crate::lexer::process_string_escapes;
    ...
    fn test_peek_error_token() {
        ...
        assert_eq!(lexer2.peek_token(), Some(&Token::Symbol("test")));
        assert_eq!(lexer2.next_token(), Some(Token::Symbol("test")));
