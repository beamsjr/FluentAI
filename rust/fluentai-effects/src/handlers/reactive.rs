...
use crate::reactive::{ReactiveState, ReactiveContext};
        ...
        match operation {
            ...
            "reactive:get" => {
                ...
                if let Some(Value::String(key)) = args.first() {
                    ...
                    Err(Error::Runtime("reactive:get requires a string key".to_string()))
                }
            }
            ...
            "reactive:set" => {
                ...
                if args.len() >= 2 {
                    if let Some(Value::String(key)) = args.first() {
                        ...
                        Err(Error::Runtime("reactive:set requires a string key".to_string()))
                    }
                } else {
                    Err(Error::Runtime("reactive:set requires key and value".to_string()))
                }
            }
            ...
            "reactive:update" => {
                ...
                if args.len() >= 2 {
                    if let (Some(Value::String(key)), Some(update_fn)) = (args.get(0), args.get(1)) {
                        ...
                        Err(Error::Runtime("reactive:update requires key and function".to_string()))
                    }
                } else {
                    Err(Error::Runtime("reactive:update requires key and function".to_string()))
                }
            ...
            "reactive:delete" => {
                ...
                if let Some(Value::String(key)) = args.first() {
                    ...
                    Err(Error::Runtime("reactive:delete requires a string key".to_string()))
                }
            }
