...
fn test_range() {
    ...
    let result = range_fn
        .call(&[Value::Integer(2), Value::Integer(7)])
        .unwrap();
    match result {
        Value::List(items) => {
            assert_eq!(items.len(), 5);
    ...
    let result = range_fn
        .call(&[Value::Integer(0), Value::Integer(10), Value::Integer(2)])
        .unwrap();
    match result {
        Value::List(items) => {
            assert_eq!(items.len(), 5);
...
fn test_max_min() {
    ...
    // Test with floats
    let float_args = vec![Value::Float(3.14), Value::Float(2.71), Value::Float(1.41)];
...
fn test_abs() {
    ...
    assert_eq!(
        abs_fn.call(&[Value::Integer(42)]).unwrap(),
        Value::Integer(42)
    );
    ...
    // Test positive float
    assert_eq!(
        abs_fn.call(&[Value::Float(3.14)]).unwrap(),
        Value::Float(3.14)
    );
...
fn test_type_predicates() {
    ...
    assert_eq!(
        int_pred.call(&[Value::Integer(42)]).unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        int_pred.call(&[Value::Float(3.14)]).unwrap(),
        Value::Boolean(false)
    );
    assert_eq!(
        int_pred
    ...
    assert_eq!(
        float_pred.call(&[Value::Float(3.14)]).unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        float_pred.call(&[Value::Integer(42)]).unwrap(),
        Value::Boolean(false)
    );
    ...
    assert_eq!(
        string_pred.call(&[Value::Integer(42)]).unwrap(),
        Value::Boolean(false)
    );
    ...
    assert_eq!(
        list_pred.call(&[Value::List(vec![])]).unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        list_pred.call(&[Value::Integer(42)]).unwrap(),
        Value::Boolean(false)
    );
    ...
    assert_eq!(
        bool_pred.call(&[Value::Boolean(true)]).unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        bool_pred.call(&[Value::Integer(42)]).unwrap(),
        Value::Boolean(false)
    );
    ...
    assert_eq!(
        nil_pred.call(&[Value::Integer(42)]).unwrap(),
        Value::Boolean(false)
    );
    ...
    assert_eq!(
        number_pred.call(&[Value::Integer(42)]).unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        number_pred.call(&[Value::Float(3.14)]).unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        number_pred
...
fn test_comparison_functions() {
    ...
    assert_eq!(
        gt.call(&[Value::Integer(5), Value::Integer(3)]).unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        gt.call(&[Value::Integer(3), Value::Integer(5)]).unwrap(),
        Value::Boolean(false)
    );
    assert_eq!(
        gt.call(&[Value::Float(3.14), Value::Float(2.71)]).unwrap(),
        Value::Boolean(true)
    );
    ...
    assert_eq!(
        le.call(&[Value::Integer(3), Value::Integer(5)]).unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        le.call(&[Value::Integer(5), Value::Integer(5)]).unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        le.call(&[Value::Integer(6), Value::Integer(5)]).unwrap(),
        Value::Boolean(false)
    );
    ...
    assert_eq!(
        ge.call(&[Value::Integer(5), Value::Integer(3)]).unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        ge.call(&[Value::Integer(5), Value::Integer(5)]).unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        ge.call(&[Value::Integer(4), Value::Integer(5)]).unwrap(),
        Value::Boolean(false)
    );
    ...
    assert_eq!(
        ne.call(&[Value::Integer(5), Value::Integer(3)]).unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        ne.call(&[Value::Integer(5), Value::Integer(5)]).unwrap(),
        Value::Boolean(false)
    );
    assert_eq!(
        ne.call(&[
...
fn test_xor() {
    ...
    assert_eq!(
        xor.call(&[Value::Boolean(true), Value::Boolean(true)])
            .unwrap(),
        Value::Boolean(false)
    );
    assert_eq!(
        xor.call(&[Value::Boolean(true), Value::Boolean(false)])
            .unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        xor.call(&[Value::Boolean(false), Value::Boolean(true)])
            .unwrap(),
        Value::Boolean(true)
    );
    assert_eq!(
        xor.call(&[Value::Boolean(false), Value::Boolean(false)])
            .unwrap(),
        Value::Boolean(false)
    );
}
...
fn test_modulo() {
    ...
    assert_eq!(
        modulo
            .call(&[Value::Integer(10), Value::Integer(3)])
            .unwrap(),
        Value::Integer(1)
    );
    assert_eq!(
        modulo
            .call(&[Value::Integer(20), Value::Integer(5)])
            .unwrap(),
        Value::Integer(0)
    );
    assert_eq!(
        modulo
            .call(&[Value::Integer(7), Value::Integer(4)])
            .unwrap(),
        Value::Integer(3)
    );
