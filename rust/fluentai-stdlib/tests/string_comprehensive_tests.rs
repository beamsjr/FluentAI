...
fn test_string_case_functions() {
    ...
    assert_eq!(
        upcase
            .call(&[Value::String("Hello World 123!".to_string())])
            .unwrap(),
        Value::String("HELLO WORLD 123!".to_string())
    );
    assert_eq!(
        upcase
            .call(&[Value::String("ALREADY UPPER".to_string())])
            .unwrap(),
    ...
    assert_eq!(
        downcase
            .call(&[Value::String("already lower".to_string())])
            .unwrap(),
    ...
    assert_eq!(
        capitalize
            .call(&[Value::String("123abc".to_string())])
            .unwrap(),
...
fn test_string_padding() {
    ...
    assert_eq!(
        pad_left
            .call(&[Value::String("test".to_string()), Value::Integer(8)])
            .unwrap(),
        Value::String("    test".to_string())
    );
    assert_eq!(
        pad_left
            .call(&[Value::String("test".to_string()), Value::Integer(4)])
            .unwrap(),
        Value::String("test".to_string()) // No padding needed
    );
    assert_eq!(
        pad_left
            .call(&[Value::String("test".to_string()), Value::Integer(2)])
            .unwrap(),
        Value::String("test".to_string()) // String already longer
    );
    assert_eq!(
        pad_left
            .call(&[Value::String("".to_string()), Value::Integer(3)])
            .unwrap(),
        Value::String("   ".to_string())
    );
    ...
    assert_eq!(
        pad_center
            .call(&[Value::String("test".to_string()), Value::Integer(9)])
            .unwrap(),
...
fn test_string_repeat() {
    ...
    assert_eq!(
        repeat
            .call(&[Value::String("ab".to_string()), Value::Integer(3)])
            .unwrap(),
        Value::String("ababab".to_string())
    );
    assert_eq!(
        repeat
            .call(&[Value::String("test".to_string()), Value::Integer(0)])
            .unwrap(),
        Value::String("".to_string())
    );
    assert_eq!(
        repeat
            .call(&[Value::String("x".to_string()), Value::Integer(5)])
            .unwrap(),
        Value::String("xxxxx".to_string())
    );
    assert_eq!(
        repeat
            .call(&[Value::String("".to_string()), Value::Integer(10)])
            .unwrap(),
        Value::String("".to_string())
    );
}
...
fn test_error_handling() {
    ...
    let repeat = stdlib.get("string-repeat").unwrap();
    assert!(repeat
        .call(&[Value::String("x".to_string()), Value::Integer(-1)])
        .is_err());
}
