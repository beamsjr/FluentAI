...
fn test_symbol_to_string() {
    ...
    let result = symbol_to_string.call(&[Value::String("my-symbol".to_string())]).unwrap();
    assert_eq!(result, Value::String("my-symbol".to_string()));
    
    // Test with various symbol-like strings
    let result = symbol_to_string.call(&[Value::String("+".to_string())]).unwrap();
    assert_eq!(result, Value::String("+".to_string()));
    
    let result = symbol_to_string.call(&[Value::String("list->string".to_string())]).unwrap();
    assert_eq!(result, Value::String("list->string".to_string()));
    
    let result = symbol_to_string.call(&[Value::String("foo-bar-baz".to_string())]).unwrap();
...
fn test_symbol_string_distinction() {
    ...
    let result = symbol_to_string.call(&[Value::String(string_with_spaces.to_string())]).unwrap();
